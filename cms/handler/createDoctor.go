...
func (h Handler) DoctorRegister (w http.ResponseWriter, r *http.Request){
	h.ParseDoctorRegisterTemplates(w,DoctorRegisterLoadFrom{
		CSRFToken: nosurf.Token(r),
	})
}
func (h Handler) DoctorRegisterPost (w http.ResponseWriter, r *http.Request){
	if err := r.ParseForm(); err != nil {
		log.Fatalf("%#v", err)
	}

	form := DoctorRegisterLoadFrom{}
	user := DoctorCreate{}
	...
	h.usermgmService.RegisterDoctorAdmin(r.Context(),&adminpb.RegisterDoctorAdminRequest{
